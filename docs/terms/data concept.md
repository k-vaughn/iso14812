...
[Comment on this page](https://github.com/ISO-TC204/iso14812/issues/new?template=page-feedback.yml&title=%5BPage+feedback%5D+data+concept&page-title=data+concept&page-path=terms%2Fdata+concept.md)
