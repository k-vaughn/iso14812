[Home](../index.md) · [Core Terms](groups/Core Terms.md) · [Architecture Enterprise View Terms](patterns/Architecture Enterprise View Terms.md) · resource

# resource

<enterprise view> [element](element.md) that represents an [entity](entity.md) that is managed, operated, referenced and/or used to develop and provide [ITS](intelligent transport system.md)

<object type="image/svg+xml" data="../../diagrams/resource.dot.svg">
    <img alt="resource Diagram" src="../../diagrams/resource.dot.png" /> <!-- Fallback for non-SVG browsers -->
</object>

Clause: 3.1.6.2

Alternative preferred term: enterprise view resource
...
| --- | --- |
| [document](document.md) | subClassOf |
| [functional object](functional object.md) | subClassOf |
| [physical object](physical object.md) | subClassOf |


---

[Comment on this page](https://github.com/ISO-TC204/iso14812/issues/new?template=page-feedback.yml&title=%5BPage+feedback%5D+resource&page-title=resource&page-path=terms%2Fresource.md)
