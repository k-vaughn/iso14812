[Home](../index.md) · [Infrastructure Terms](groups/Infrastructure Terms.md) · [Physical Traffic Separator Terms](patterns/Physical Traffic Separator Terms.md) · physical traffic separator

# physical traffic separator

mechanism used to physically separate a travelled way or pathway from the adjacent environment

<object type="image/svg+xml" data="../../diagrams/physical traffic separator.dot.svg">
    <img alt="physical traffic separator Diagram" src="../../diagrams/physical traffic separator.dot.png" /> <!-- Fallback for non-SVG browsers -->
</object>
