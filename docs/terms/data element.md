...
[Comment on this page](https://github.com/ISO-TC204/iso14812/issues/new?template=page-feedback.yml&title=%5BPage+feedback%5D+data+element&page-title=data+element&page-path=terms%2Fdata+element.md)
