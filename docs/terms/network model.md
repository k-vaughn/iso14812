[Home](../index.md) · [Service Terms](groups/Service Terms.md) · [Network Model Terms](patterns/Network Model Terms.md) · network model

# network model

infrastructure framework for the agreement between a [service provider](service provider.md) and a [user](user.md)

<object type="image/svg+xml" data="../../diagrams/network model.dot.svg">
    <img alt="network model Diagram" src="../../diagrams/network model.dot.png" /> <!-- Fallback for non-SVG browsers -->
</object>
...
## Specializations of network model
