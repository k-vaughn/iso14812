...
[Comment on this page](https://github.com/ISO-TC204/iso14812/issues/new?template=page-feedback.yml&title=%5BPage+feedback%5D+information+transfer&page-title=information+transfer&page-path=terms%2Finformation+transfer.md)
