[Home](../index.md) · [Service Terms](groups/Service Terms.md) · [Transport Service Application Terms](patterns/Transport Service Application Terms.md) · mobility app

# mobility app

[ITS-S application implementation](ITS-S application implementation.md) designed to assist an individual transport consumer in understanding transport-related information, making decisions, and/or acting upon decisions

<object type="image/svg+xml" data="../../diagrams/mobility app.dot.svg">
    <img alt="mobility app Diagram" src="../../diagrams/mobility app.dot.png" /> <!-- Fallback for non-SVG browsers -->
</object>
...
## Specializations of mobility app
...
## Relationships for mobility app

| Property | Constraint |
| --- | --- |
| subClassOf | its-sApplicationImplementation |


---

[Comment on this page](https://github.com/ISO-TC204/iso14812/issues/new?template=page-feedback.yml&title=%5BPage+feedback%5D+mobility+app&page-title=mobility+app&page-path=terms%2Fmobility+app.md)
