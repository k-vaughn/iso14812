[Home](../index.md) · [Core Terms](groups/Core Terms.md) · [Entity Terms](patterns/Entity Terms.md) · material entity

# material entity

[entity](entity.md) that occupies three-dimensional space

<object type="image/svg+xml" data="../../diagrams/material entity.dot.svg">
    <img alt="material entity Diagram" src="../../diagrams/material entity.dot.png" /> <!-- Fallback for non-SVG browsers -->
</object>
...
## Specializations of material entity
...
## Relationships for material entity

| Property | Constraint |
| --- | --- |
| subClassOf | entity |

## References to material entity
